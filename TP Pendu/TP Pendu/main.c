/*BUT:L'utilisateur doit deviné le mot caché en cherchant lettre par lettre et en faisant le moins de fautes possibles
//ENTREE:1 caractere
...
int main()
{
        ...
        //construit le tableau de caractere correctement pour éviter des erreurs
        motTrouver[tailleMot]='\0';

        HANDLE H=GetStdHandle(STD_OUTPUT_HANDLE);   //création de la fenêtre
        ...
        do{
                ...
                do{
                        ...
                        if (test) {     //si le caractere à deja ete tapper
...
/*BUT:Affiche un texte à l'utilisateur
//ENTREE:
